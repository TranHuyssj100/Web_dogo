...
<?php 
	...
	*/
	class product
	{
		...
		public function getLastestbedroom()
		{
			$query = "SELECT * FROM tbl_product where brandId = '15' order by productId desc limit 1";
			$result = $this->db->select($query);
			return $result;	
		}
		public function getLastestlivingroom()
		{
			$query = "SELECT * FROM tbl_product where brandId = '16' order by productId desc limit 1";
			$result = $this->db->select($query);
			return $result;	
		}
		public function getLastestkitchen()
		{
			$query = "SELECT * FROM tbl_product where brandId = '17' order by productId desc limit 1";
			$result = $this->db->select($query);
			return $result;	
		}
		public function getAll_livingRoom()
		{
			$query = "SELECT * FROM tbl_product where brandId = '16' order by productId desc";
			$result = $this->db->select($query);
			return $result;
		}
		public function getAll_bedRoom()
		{
			$query = "SELECT * FROM tbl_product where brandId = '15' order by productId desc";
			$result = $this->db->select($query);
			return $result;
		}
		public function getAll_kitChen()
		{
			$query = "SELECT * FROM tbl_product where brandId = '17' order by productId desc";
			$result = $this->db->select($query);
			return $result;
		}
		// public function getLastestBatRoom()
		// {
		// 	$query = "SELECT * FROM tbl_product where brandId = '17' order by productId desc limit 1";
		// 	$result = $this->db->select($query);
		// 	return $result;	
